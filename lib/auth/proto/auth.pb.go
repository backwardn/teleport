...
func (Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_auth_75cbcd9655be445b, []int{0}
}
...
func (*Watch) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_75cbcd9655be445b, []int{1}
}
...
func (*WatchKind) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_75cbcd9655be445b, []int{2}
}
...
func (*Certs) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_75cbcd9655be445b, []int{3}
}
...
func (*UserCertsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_75cbcd9655be445b, []int{4}
}
...
// Resource is a message which contains one of a set of possible
// resource types.  This message is intended for use in APIs which act
// directly on the resource API, rather than on a specific resource type.
type Resource struct {
	// Types that are valid to be assigned to Resource:
	//	*Resource_User
	//	*Resource_CertAuthority
	//	*Resource_Role
	//	*Resource_OTPVerifier
	//	*Resource_U2FRegistration
	//	*Resource_U2FRegistrationCounter
	//	*Resource_PasswordHash
...
func (*Resource) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_75cbcd9655be445b, []int{5}
}
...
type Resource_User struct {
	User *services.UserV2 `protobuf:"bytes,1,opt,name=User,oneof"`
}
type Resource_CertAuthority struct {
	CertAuthority *services.CertAuthorityV2 `protobuf:"bytes,2,opt,name=CertAuthority,oneof"`
}
type Resource_Role struct {
	Role *services.RoleV3 `protobuf:"bytes,5,opt,name=Role,oneof"`
}
type Resource_OTPVerifier struct {
	OTPVerifier *services.OTPVerifierV1 `protobuf:"bytes,8,opt,name=OTPVerifier,oneof"`
}
type Resource_U2FRegistration struct {
	U2FRegistration *services.U2FRegistrationV1 `protobuf:"bytes,9,opt,name=U2FRegistration,oneof"`
}
type Resource_U2FRegistrationCounter struct {
	U2FRegistrationCounter *services.U2FRegistrationCounterV1 `protobuf:"bytes,10,opt,name=U2FRegistrationCounter,oneof"`
}
type Resource_PasswordHash struct {
	PasswordHash *services.PasswordHashV1 `protobuf:"bytes,11,opt,name=PasswordHash,oneof"`
}

func (*Resource_User) isResource_Resource()                   {}
func (*Resource_CertAuthority) isResource_Resource()          {}
func (*Resource_Role) isResource_Resource()                   {}
func (*Resource_OTPVerifier) isResource_Resource()            {}
func (*Resource_U2FRegistration) isResource_Resource()        {}
func (*Resource_U2FRegistrationCounter) isResource_Resource() {}
func (*Resource_PasswordHash) isResource_Resource()           {}
...
func (m *Resource) GetUser() *services.UserV2 {
	if x, ok := m.GetResource().(*Resource_User); ok {
		return x.User
	}
	return nil
}

func (m *Resource) GetCertAuthority() *services.CertAuthorityV2 {
	if x, ok := m.GetResource().(*Resource_CertAuthority); ok {
		return x.CertAuthority
	}
	return nil
}

func (m *Resource) GetRole() *services.RoleV3 {
	if x, ok := m.GetResource().(*Resource_Role); ok {
		return x.Role
	}
	return nil
}

func (m *Resource) GetOTPVerifier() *services.OTPVerifierV1 {
	if x, ok := m.GetResource().(*Resource_OTPVerifier); ok {
		return x.OTPVerifier
	}
	return nil
}

func (m *Resource) GetU2FRegistration() *services.U2FRegistrationV1 {
	if x, ok := m.GetResource().(*Resource_U2FRegistration); ok {
		return x.U2FRegistration
	}
	return nil
}

func (m *Resource) GetU2FRegistrationCounter() *services.U2FRegistrationCounterV1 {
	if x, ok := m.GetResource().(*Resource_U2FRegistrationCounter); ok {
		return x.U2FRegistrationCounter
	}
	return nil
}

func (m *Resource) GetPasswordHash() *services.PasswordHashV1 {
	if x, ok := m.GetResource().(*Resource_PasswordHash); ok {
...
func (*Resource) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Resource_OneofMarshaler, _Resource_OneofUnmarshaler, _Resource_OneofSizer, []interface{}{
		(*Resource_User)(nil),
		(*Resource_CertAuthority)(nil),
		(*Resource_Role)(nil),
		(*Resource_OTPVerifier)(nil),
		(*Resource_U2FRegistration)(nil),
		(*Resource_U2FRegistrationCounter)(nil),
		(*Resource_PasswordHash)(nil),
	}
}
...
func _Resource_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Resource_OTPVerifier:
		_ = b.EncodeVarint(8<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.OTPVerifier); err != nil {
			return err
		}
	case *Resource_U2FRegistration:
		_ = b.EncodeVarint(9<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.U2FRegistration); err != nil {
			return err
		}
	case *Resource_U2FRegistrationCounter:
		_ = b.EncodeVarint(10<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.U2FRegistrationCounter); err != nil {
			return err
		}
	case *Resource_PasswordHash:
		_ = b.EncodeVarint(11<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PasswordHash); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Resource.Resource has unexpected type %T", x)
	}
	return nil
}
...
func _Resource_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Resource)
	switch tag {
	case 1: // Resource.User
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(services.UserV2)
		err := b.DecodeMessage(msg)
		m.Resource = &Resource_User{msg}
		return true, err
	case 2: // Resource.CertAuthority
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(services.CertAuthorityV2)
		err := b.DecodeMessage(msg)
		m.Resource = &Resource_CertAuthority{msg}
		return true, err
	case 5: // Resource.Role
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(services.RoleV3)
		err := b.DecodeMessage(msg)
		m.Resource = &Resource_Role{msg}
		return true, err
	case 8: // Resource.OTPVerifier
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(services.OTPVerifierV1)
		err := b.DecodeMessage(msg)
		m.Resource = &Resource_OTPVerifier{msg}
		return true, err
	case 9: // Resource.U2FRegistration
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(services.U2FRegistrationV1)
		err := b.DecodeMessage(msg)
		m.Resource = &Resource_U2FRegistration{msg}
		return true, err
	case 10: // Resource.U2FRegistrationCounter
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(services.U2FRegistrationCounterV1)
		err := b.DecodeMessage(msg)
		m.Resource = &Resource_U2FRegistrationCounter{msg}
		return true, err
	case 11: // Resource.PasswordHash
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(services.PasswordHashV1)
		err := b.DecodeMessage(msg)
		m.Resource = &Resource_PasswordHash{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Resource_OneofSizer(msg proto.Message) (n int) {
	...
	case *Resource_Role:
		...
		n += s
	case *Resource_OTPVerifier:
		s := proto.Size(x.OTPVerifier)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Resource_U2FRegistration:
		s := proto.Size(x.U2FRegistration)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Resource_U2FRegistrationCounter:
		s := proto.Size(x.U2FRegistrationCounter)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Resource_PasswordHash:
		s := proto.Size(x.PasswordHash)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *Resource) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Resource != nil {
		nn15, err := m.Resource.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn15
...
func (m *Resource_CertAuthority) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CertAuthority != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAuth(dAtA, i, uint64(m.CertAuthority.Size()))
		n17, err := m.CertAuthority.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *Resource_Role) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Role != nil {
		dAtA[i] = 0x2a
		i++
...
func (m *Resource_OTPVerifier) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.OTPVerifier != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintAuth(dAtA, i, uint64(m.OTPVerifier.Size()))
		n19, err := m.OTPVerifier.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *Resource_U2FRegistration) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.U2FRegistration != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintAuth(dAtA, i, uint64(m.U2FRegistration.Size()))
		n20, err := m.U2FRegistration.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *Resource_U2FRegistrationCounter) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.U2FRegistrationCounter != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintAuth(dAtA, i, uint64(m.U2FRegistrationCounter.Size()))
		n21, err := m.U2FRegistrationCounter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *Resource_PasswordHash) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PasswordHash != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintAuth(dAtA, i, uint64(m.PasswordHash.Size()))
		n22, err := m.PasswordHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *Resource_CertAuthority) Size() (n int) {
	var l int
	_ = l
	if m.CertAuthority != nil {
		l = m.CertAuthority.Size()
...
func (m *Resource_Role) Size() (n int) {
	var l int
	_ = l
	if m.Role != nil {
		l = m.Role.Size()
...
func (m *Resource_OTPVerifier) Size() (n int) {
	var l int
	_ = l
	if m.OTPVerifier != nil {
		l = m.OTPVerifier.Size()
		n += 1 + l + sovAuth(uint64(l))
	}
	return n
}
func (m *Resource_U2FRegistration) Size() (n int) {
	var l int
	_ = l
	if m.U2FRegistration != nil {
...
func (m *Resource_U2FRegistrationCounter) Size() (n int) {
	var l int
	_ = l
	if m.U2FRegistrationCounter != nil {
		l = m.U2FRegistrationCounter.Size()
		n += 1 + l + sovAuth(uint64(l))
	}
	return n
}
func (m *Resource_PasswordHash) Size() (n int) {
	var l int
	_ = l
	if m.PasswordHash != nil {
...
func (m *Resource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Resource = &Resource_CertAuthority{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Role", wireType)
			...
			m.Resource = &Resource_Role{v}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OTPVerifier", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &services.OTPVerifierV1{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Resource = &Resource_OTPVerifier{v}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
			...
			v := &services.U2FRegistrationV1{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Resource = &Resource_U2FRegistration{v}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field U2FRegistrationCounter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &services.U2FRegistrationCounterV1{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Resource = &Resource_U2FRegistrationCounter{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
			...
			v := &services.PasswordHashV1{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Resource = &Resource_PasswordHash{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAuth(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("auth.proto", fileDescriptor_auth_75cbcd9655be445b) }

var fileDescriptor_auth_75cbcd9655be445b = []byte{
	...
	,
}
